...
mv populationGPL570.txt populationGPL570.txt input
...
java -Xmx2G -jar bin/ontologizer.jar --go input/gene_ontology_ext.obo --association input/gene_association.goa_human --population input/populationGPL570.txt --studyset input/studyGDS2821.txt --dot 0.05 --resamplingsteps 1000 --mtc Westfall-Young-Single-Step 
